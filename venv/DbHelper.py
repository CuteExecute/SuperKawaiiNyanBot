from sqlalchemy import create_engine, select, Table, Column, Integer, Boolean, String, MetaData, ForeignKey, func
from sqlalchemy.sql import select, and_, extract
import datetime
from datetime import datetime

# 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐 卐
...
def user_create(name, dis_id):
    if not is_user_exists(dis_id):
        ...
        print("Такой уже есть, придурок блять!")
...
def user_clear_all_marks(dis_id):
    #  TODO надо еще убрать все отметки с месежей неактуальных ОЙ ДА И ПОХУЙ НА ЭТИ ОТМЕТКИ В РОТ ИХ ЕБАТЬ
